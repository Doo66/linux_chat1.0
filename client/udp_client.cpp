...
size_t udp_client::print_message(int fd,std::string xiaoxi)
{
	int ret = write(fd ,xiaoxi.c_str(),xiaoxi.size());
	if(ret == -1)
	{
		raise(SIGINT);
	}
...
//	print_message(fd,"this is a test !!!!!!!!!!!");
//	print_message(fd,_msg);
////////////////////////////////////////////////////////////////////////
	...
	if( -1 == _size ){
		////////////////////////////////////////////////
		print_message(fd,"sendto data error!");
		/////////////////////////////////////////
	}
	/////////////////////////////////////////////////////////////////
	print_message(fd,"send message success and the meaasge is down\n");
	print_message(fd,_msg+"\n");
	/////////////////////////////////////////////////////////////////
	return _size;
}
...
ssize_t udp_client::recv_msg(std::string &_msg)
{
	...
	if( -1 == _size ){
		...
		_msg = buf;
	////////////////////////////////////////////////////////////////
	print_message(fd,"recv message is down       !\n");
	print_message(fd,_msg+"\n");
	///////////////////////////////////////////////////////////////
	}
	return _size;
